...
Route.group(() => {
  ...
  Route.post('/chats/data_display_profile', 'ChatsController.data_display_profile').as('chats.data_display_profile')
  ...
  Route.post('/chats/data_group_profile', 'ChatsController.data_group_profile').as('chats.data_group_profile')
